...
//                    EntityUtils.consume(response.getEntity());  
                    ...
                    e.printStackTrace();
                    logger.error(e.getMessage()+":"+httpStr);
                    return ERROR;
                }  
            }  
        }  
    ...
    public static String doPost(String apiUrl, Object json) {  
        ...
        try {  
            httpPost.setConfig(requestConfig);  
            StringEntity stringEntity = new StringEntity(encodeUTF8Str(String.valueOf(json)));//解决中文乱码问题  
...
//                    EntityUtils.consume(response.getEntity());  
	 ...
	 * @return
	 */
	public static String convertStreamToStringBasic(InputStream is) {
	...
	public static String encodeUTF8Str(String str) {
		String encoderJson = "";
		try {
			encoderJson = URLEncoder.encode(str, HTTP.UTF_8);
    ...
    public static void main(String[] args) throws Exception {
    	...
    	map.put("1", 1);
    	map.put("2", 2);
    	System.out.println(doGet("http://localhost:8080/social-service/group/get", map));
    }  
}
